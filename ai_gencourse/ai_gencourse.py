...
@XBlock.wants('i18n')
class aigencoursexblock(XBlock, StudioEditableXBlockMixin, CompletableXBlockMixin):
    """
        AI GenCourse xblock - Helps student to ask for improvement of their answer once
    """

    display_name = String(
        display_name=_('Display Name'),
        help=_('Display name for this module'),
        default="AI GenCourse",
